...
@login_required(login_url="/uauth/")  
...
def post_detail_view(request, post_id):
    ...
    comments = [
        {'author': 'alsdlswm72', 'text': '코드노바? 처음 들어본 회사인데용...', 'created_at': '2025.08.31. 12:20', 'is_own_comment': False},
        {'author': '통통통', 'text': '비밀 댓글입니다.', 'created_at': '2025.08.31. 12:22', 'is_own_comment': True},
        {'author': '제레미프림퐁', 'text': '궁금하네여.', 'created_at': '2025.08.31. 12:24', 'is_own_comment': False},
    ]
    context = {
        'post': post,
        'comments': comments,
